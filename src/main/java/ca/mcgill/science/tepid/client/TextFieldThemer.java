...
public class TextFieldThemer {
	...
	static {
		bg = new BufferedImage[] {
			loadImage(PasswordDialog.class.getResourceAsStream("textfield-0.png")), 
			loadImage(PasswordDialog.class.getResourceAsStream("textfield-1.png")), 
			loadImage(PasswordDialog.class.getResourceAsStream("textfield-2.png")),
			loadImage(PasswordDialog.class.getResourceAsStream("textfield-3.png"))
		};
	}
