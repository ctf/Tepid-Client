...
class GtkMenuEntry implements MenuEntry, GCallback {
    ...
    @Override
    public int callback(final Pointer instance, final Pointer data) {
    ...
    @Override
    public void setImage(final String cacheName, final InputStream imageStream) {
        if (imageStream == null) {
            setImage_(null);
        } else {
    ...
    @Override
    public void setCallback(final SystemTrayMenuAction callback) {
        this.callback = callback;
    }
