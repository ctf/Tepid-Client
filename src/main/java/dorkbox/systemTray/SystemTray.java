...
import dorkbox.systemTray.windows.Win32SystemTray;
...
public abstract class SystemTray {
    ...
    private static void init() {
        ...
        if (OS.isWindows()) {
            trayType = Win32SystemTray.class;
        }

        // this is probably mac
     ...
     */
    protected MenuEntry getMenuEntry(String menuText) {
    ...
    protected abstract void setIcon_(String iconPath);
     ...
     */
    public void setIcon(String cacheName, InputStream imageStream) {
     ...
     */
    public final void addMenuEntry(String menuText, SystemTrayMenuAction callback) {
     ...
     * @param callback  callback that will be executed when this menu entry is clicked
     */
    public abstract void addMenuEntry(String menuText, String imagePath, SystemTrayMenuAction callback);
     ...
     * @param callback callback that will be executed when this menu entry is clicked
     */
    public abstract void addMenuEntry(String menuText, URL imageUrl, SystemTrayMenuAction callback);
     ...
     * @param callback    callback that will be executed when this menu entry is clicked
     */
    public abstract void addMenuEntry(String menuText, String cacheName, InputStream imageStream, SystemTrayMenuAction callback);
     ...
     */
    @Deprecated
    public abstract void addMenuEntry(String menuText, InputStream imageStream, SystemTrayMenuAction callback);
     ...
     */
    public final void updateMenuEntry_Text(String origMenuText, String newMenuText) {
     ...
     */
    public final void updateMenuEntry_Image(String origMenuText, String imagePath) {
        synchronized (menuEntries) {
            MenuEntry menuEntry = getMenuEntry(origMenuText);
     ...
     */
    public final void updateMenuEntry_Image(String origMenuText, URL imageUrl) {
        synchronized (menuEntries) {
            MenuEntry menuEntry = getMenuEntry(origMenuText);
     ...
     */
    public final void updateMenuEntry_Image(String origMenuText, String cacheName, InputStream imageStream) {
        synchronized (menuEntries) {
            MenuEntry menuEntry = getMenuEntry(origMenuText);
     ...
     */
    @Deprecated
    public final void updateMenuEntry_Image(String origMenuText, InputStream imageStream) {
        synchronized (menuEntries) {
            MenuEntry menuEntry = getMenuEntry(origMenuText);
     ...
     */
    public final void updateMenuEntry_Callback(String origMenuText, SystemTrayMenuAction newCallback) {
        synchronized (menuEntries) {
            MenuEntry menuEntry = getMenuEntry(origMenuText);
     ...
     * @param newCallback  the new callback (this will replace the original callback)
     */
    public final void updateMenuEntry(String origMenuText, String newMenuText, SystemTrayMenuAction newCallback) {
        synchronized (menuEntries) {
            MenuEntry menuEntry = getMenuEntry(origMenuText);
     ...
     */
    public final void removeMenuEntry(final String menuText) {
        synchronized (menuEntries) {
