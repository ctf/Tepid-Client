...
public class Notification extends JWindow {
	...
	public Notification() {
		...
		final JPanel content = new JPanel() {
			...
			BufferedImage xButton = loadImage(Notification.class.getResourceAsStream("x.png")),
			xButtonHover = loadImage(Notification.class.getResourceAsStream("x_hover.png"));
	...
	public void setIcon(String icon) {
		this.icon = loadImage(Notification.class.getResourceAsStream("icons/" + icon + ".png"));
	}
