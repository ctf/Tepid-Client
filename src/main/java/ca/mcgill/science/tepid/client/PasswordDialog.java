...
public class PasswordDialog extends JFrame {
	...
	private boolean ok;
	private final BufferedImage authBg = loadImage(PasswordDialog.class.getResourceAsStream("authbg.png"));
	...
	static {
		for (int i = 0; i < icon.length; i++) {
			icon[i] = loadImage(PasswordDialog.class.getResourceAsStream("icon/key9-"+i+".png"));
		}
	}
	...
	private PasswordDialog(Q<Result> q) {
		...
		JLabel lblDisclaimer = new JLabel("<html><p>By continuing you agree<br>to the <a href=\"#\">terms & conditions</a></p></html>");
